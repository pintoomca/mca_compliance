...
@section('title', 'Compliance Monitoring Portal')
@section('content')
<div class="slider-area ">

<div class="slider-active">
<div class="single-slider slider-height d-flex align-items-center" data-background="{{asset('assets/master/img/hero/h1_hero.jpg')}}">
<div class="container">
<div class="row">
...
<img src="{{asset('assets/master/img/team/team_1.jpg')}}" alt="">
</div>
...
<div class="single-profile-front">
<div class="profile-img">
<img src="{{asset('assets/master/img/team/team_2.jpg')}}" alt="">
</div>
<div class="profile-caption">
...
<img src="{{asset('assets/master/img/team/wetrusted.jpg')}}" alt="">
</div>
</div>
...
<img src="{{asset('assets/master/img/service/completed_case_1.png')}}" alt="">
...
<div class="single-cases-img">
<img src="{{asset('assets/master/img/service/completed_case_2.png')}}" alt="">
...
<img src="{{asset('assets/master/img/logo/testimonial.png')}}" class="ani-btn " alt="">
</div>
...
<img src="{{asset('assets/master/img/recent/rcent_1.png')}}" alt="">
</div>
...
<div class="single-recent-cap mb-30">
<div class="recent-img">
<img src="{{asset('assets/master/img/recent/rcent_2.png')}}" alt="">
</div>
<div class="recent-cap">
<span>Audit</span>
<h4><a href="single-blog.html">Amazing Places To Visit In Summer</a></h4>
...
<div class="single-recent-cap mb-30">
<div class="recent-img">
<img src="{{asset('assets/master/img/recent/rcent_3.png')}}" alt="">
</div>
<div class="recent-cap">
<span>Business planing</span>
<h4><a href="single-blog.html">Amazing Places To Visit In Summer</a></h4>
