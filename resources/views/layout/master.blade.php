...
<link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/master/img/favicon.ico')}}">
...
<link rel="stylesheet" href="{{asset('assets/master/assets/css/style.css')}}">
</head>
<body>
...
<img src="{{asset('assets/master/img/logo/logo.png')}}" alt="">
</div>
</div>
</div>
</div>
