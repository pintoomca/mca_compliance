...
<link href="{{asset('assets/home4/css/templatemo_style.css')}}" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="{{asset('assets/home4/css/tabcontent.css')}}" />
<script type="text/javascript" src="{{asset('assets/home4/js/tabcontent.js')}}">
/***********************************************
    	...
    	<div id="templatemo_main_leftcol">
        	<div class="templatemo_leftcol_subcol">
            	...
            	<div id="templatemo_topnews">
                    <img src="{{asset('assets/home4/images/templatemo_image_01.jpg')}}" alt="image" />
              ...
              <div id="image_section">
                        <a href="#"><img src="{{asset('assets/home4/images/templatemo_image_02.jpg')}}" alt="image" /></a>
                        <a href="#"><img src="{{asset('assets/home4/images/templatemo_image_03.jpg')}}" alt="image" /></a>
                        <a href="#"><img src="{{asset('assets/home4/images/templatemo_image_04.jpg')}}" alt="image" /></a>
                        <a href="#"><img src="{{asset('assets/home4/images/templatemo_image_05.jpg')}}" alt="image" /></a>
                        <a href="#"><img src="{{asset('assets/home4/images/templatemo_image_06.jpg')}}" alt="image" /></a>
                        <a href="#"><img src="{{asset('assets/home4/images/templatemo_image_07.jpg')}}" alt="image" /></a>
					</div>
            ...
            <div class="templatemo_leftcol_subcol">
				<div class="regular_section">
                    <h2>General News</h2>
					<div class="newsbox"><img src="{{asset('assets/home4/images/templatemo_image_08.jpg')}}" alt="image" /><span class="newstitle">News Title 01</span><br />
                        <p>
                ...
                <div class="regular_section">
                    <h2>Sports</h2>
					<div class="newsbox"><img src="{{asset('assets/home4/images/templatemo_image_12.jpg')}}" alt="image" /><span class="newstitle">News Title 02</span><br />
                        <p>
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
				</div> -->
            </div>
            ...
            <div class="tab_section">
                ...
                <div class="tabcontent_section">
                    <div id="health" class="tabcontent">
                        <div class="topnews">
                            <img src="{{asset('assets/home4/images/templatemo_image_08.jpg')}}" alt="image" />
                            <h4>Health News</h4>
                            <p>
                    ...
                    <div id="entertainment" class="tabcontent">
	                    <div class="topnews">
                            <img src="{{asset('assets/home4/images/templatemo_image_12.jpg')}}" alt="image" />
        ...
        <div id="templatemo_main_rightcol">
        	<div class="templatemo_rcol_sectionwithborder">
            	<div id="templatemo_video_section">
                    <h2>Latest Videos</h2>
                    <div class="video_box">
                        <img src="{{asset('assets/home4/images/templatemo_image_09.jpg')}}" alt="image" />
                        <a href="#"><span>Play:</span> Lorem ipsum dolor sit amet</a>
                    </div>
                    <div class="video_box">
                        <img src="{{asset('assets/home4/images/templatemo_image_10.jpg')}}" alt="image" />
                        <a href="#"><span>Play:</span> Nunc quis sem nec tincidunt</a>                    
                    </div> 
                    <div class="video_box">
                        <img src="{{asset('assets/home4/images/templatemo_image_11.jpg')}}" alt="image" />
