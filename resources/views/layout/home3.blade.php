...
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/bootstrap.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/font-awesome.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/animate.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/li-scroller.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/slick.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/theme.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/home3/css/style.css')}}">
<!--[if lt IE 9]>
<script src="{{asset('assets/home3/js/html5shiv.min.js')}}"></script>
<script src="{{asset('assets/home3/js/respond.min.js')}}"></script>
<![endif]-->
</head>
<body>
  ...
  <div class="box_wrapper">
    <header id="header">
      ...
      <div class="header_bottom">
        ...
        <div class="top_addarea"><a href="#"><img src="{{asset('assets/home3/images/addbanner_728x90_V1.jpg')}}" alt=""></a></div>
      </div>
    </header>
    ...
    <div class="thumbnail_slider_area">
      <div class="owl-carousel">
        <div class="signle_iteam"> <img src="{{asset('assets/home3/images/395x396.jpg')}}" alt="">
          ...
          <div class="row">
            <div class="left_bar">
              <div class="single_leftbar">
                ...
                <div class="singleleft_inner">
                  <ul class="recentpost_nav wow fadeInDown">
                    <li><a href="pages/single_page.html"><img src="{{asset('assets/home3/images/150x80.jpg')}}" alt=""></a> <a class="recent_title" href="pages/single_page.html"> Curabitur ac dictum nisl eu hendrerit ante</a></li>
                    <li><a href="pages/single_page.html"><img src="{{asset('assets/home3/images/150x80.jpg')}}" alt=""></a> <a class="recent_title" href="pages/single_page.html"> Curabitur ac dictum nisl eu hendrerit ante</a></li>
                    <li><a href="pages/single_page.html"><img src="{{asset('assets/home3/images/150x80.jpg')}}" alt=""></a> <a class="recent_title" href="pages/single_page.html"> Curabitur ac dictum nisl eu hendrerit ante</a></li>
                  </ul>
                </div>
              ...
              <div class="single_leftbar wow fadeInDown">
                ...
                <div class="singleleft_inner"> <a href="#"><img src="{{asset('assets/home3/images/150x600.jpg')}}" alt=""></a></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="middle_bar">
              <div class="featured_sliderarea">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active"> <img src="{{asset('assets/home3/images/668x328.jpg')}}" alt="">
                      <div class="carousel-caption">
                        <h1><a href="#"> Aliquam malesuada diam eget turpis varius 1</a></h1>
                      </div>
                    </div>
                    <div class="item"> <img src="{{asset('assets/home3/images/668x328.jpg')}}" alt="">
                      <div class="carousel-caption">
              ...
              <div class="single_category wow fadeInDown">
                ...
                <div class="single_category_inner">
                  <ul class="catg_nav">
                    <li>
                      <div class="catgimg_container"> <a class="catg1_img" href="pages/single_page.html"> <img src="{{asset('assets/home3/images/310x150.jpg')}}" alt=""> </a></div>
                    ...
                    <li>
                      <div class="catgimg_container"> <a class="catg1_img" href="#"> <img src="{{asset('assets/home3/images/310x150.jpg')}}" alt=""> </a></div>
              ...
              <div class="single_category  wow fadeInDown">
                ...
                <div class="single_category_inner">
                  <ul class="catg_nav catg_nav2">
                    <li>
                      <div class="catgimg_container"> <a class="catg1_img" href="#"> <img src="{{asset('assets/home3/images/310x300.jpg')}}" alt=""> </a></div>
                  ...
                  <div class="single_category">
                    ...
                    <div class="single_category_inner">
                      <ul class="catg_nav catg_nav3">
                        <li>
                          <div class="catgimg_container"> <a class="catg1_img" href="pages/single_page.html"> <img src="{{asset('assets/home3/images/292x150.jpg')}}" alt=""> </a></div>
                          <a class="catg_title" href="#"> Curabitur ac dictum nisl eu hendrerit ante</a>
                          <div class="sing_commentbox">
                            <p><i class="fa fa-calendar"></i>19 Nov 2045</p>
                            <a href="#"><i class="fa fa-comments"></i>20 Comments</a></div>
                      ...
                      <div class="catg3_bottompost wow fadeInDown">
                        <ul class="catg3_snav">
                          <li>
                            <div class="media"> <a class="media-left" href="pages/single_page.html"> <img src="{{asset('assets/home3/images/70x70.jpg')}}" alt=""> </a>
                    ...
                    <div class="single_category_inner">
                      ...
                      <div class="catg3_bottompost wow fadeInDown">
                        <ul class="catg3_snav">
                          ...
                          <li>
                            <div class="media"> <a class="media-left" href="#"> <img src="{{asset('assets/home3/images/70x70.jpg')}}" alt=""> </a>
                              <div class="media-body"> <a class="catg_title" href="#"> Aliquam malesuada diam eget turpis varius</a>
                                <div class="sing_commentbox">
                                  <p><i class="fa fa-calendar"></i>19 Nov 2045</p>
                                  <a href="#"><i class="fa fa-comments"></i>20 Comments</a></div>
              ...
              <div class="single_category wow fadeInDown">
                ...
                <div class="single_category_inner">
                  <ul class="catg3_snav catg5_nav">
                    <li>
                      <div class="media"> <a href="#" class="media-left"> <img alt="" src="{{asset('assets/home3/images/70x70.jpg')}}"> </a>
          ...
          <div class="row">
            <div class="right_bar">
              <div class="single_leftbar wow fadeInDown">
                ...
                <div class="singleleft_inner">
                  <ul class="catg3_snav ppost_nav wow fadeInDown">
                    <li>
                      <div class="media"> <a href="pages/single_page.html" class="media-left"> <img alt="" src="{{asset('assets/home3/images/70x70.jpg')}}"> </a>
              ...
              <div class="single_leftbar wow fadeInDown">
                ...
                <div class="singleleft_inner"> <a href="#"><img alt="" src="{{asset('assets/home3/images/262x218.jpg')}}"></a></div>
              </div>
              <div class="single_leftbar wow fadeInDown">
...
<script src="{{asset('assets/home3/js/jquery.min.js')}}"></script>
<script src="{{asset('assets/home3/js/wow.min.js')}}"></script>
<script src="{{asset('assets/home3/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/home3/js/slick.min.js')}}"></script>
<script src="{{asset('assets/home3/js/jquery.li-scroller.1.0.js')}}"></script>
<script src="{{asset('assets/home3/js/custom.js')}}"></script>
</body>
</html>