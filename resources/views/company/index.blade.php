                            ...
                            <div class="col-sm-8">
                                <div class="card" style="margin-top:-35px; margin-bottom:5px;">
                                    <div class="card-body card-block">
                                        <form class="form-header" action="{{url('company/list')}}" method="GET">
                                ...
                                <div class="card" style="margin-top:-35px; margin-bottom:5px;">
                                    <div class="card-body card-block">
                                    <button type="button" class="btn btn-outline-primary btn-lg active">Total Companies: <?=$total;?></button>
                                    </div>
                                </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-borderless table-striped  ">
                                        ...
                                        @foreach ($notice_data as $user)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $user->CIN }}</td>
                                                <td>{{ $user->compname }}</td>
                                                <td>{{ $user->ADDR_LINE1 }} <br>{{ $user->ADDR_LINE2 }}</td>
                                                <td class="text-right"><a href="{{url('company/view?cin=')}}{{ $user->CIN }}" target="_blank"><i class="fa fa-table"></i></a></td>
                                            </tr>
